...
\question Draw a van Kampen diagram for the group
  ...
  \begin{solution}
    ...
    \begin{tikzpicture}
      ...
      \foreach \x in {0,216,288}
      \node[vertex] (outer\x) at (\x:3) {};

      \draw[xarrow,bend right=102,distance=5.25cm] (outer0) to node[letter] {$x$} (outer216);
      \draw[xarrow,bend right=33] (outer216) to node[letter] {$x$} (outer288);
      \draw[xarrow,bend right=33] (outer288) to node[letter,swap] {$x$} (outer0);

      \foreach \x in {0,72,144,216,288}
      \node[vertex] (inner\x) at ($(0.75,0) + (\x:2.25)$) {};

      \draw[xarrow] (inner0) to node[letter] {$x$} (inner72);
      \draw[yarrow] (inner144) to node[letter] {$y$} (inner72);
      \draw[xarrow] (inner216) to node[letter] {$x$} (inner144);
      \draw[xarrow] (inner288) to node[letter] {$x$} (inner216);
      \draw[yarrow] (inner288) to node[letter] {$y$} (inner0);
      \draw[yarrow] (inner216) to node[letter] {$y$} (outer216);

      \node[vertex] (a) at ($(inner144)!0.33!(inner288)$) {};
      \node[vertex] (b) at ($(a)!0.5!(inner0)$) {};
      \node[vertex] (c) at ($(a)!0.5!(inner288)$) {};

      \draw[yarrow] (a) to node[letter] {$y$} (inner144);
      \draw[xarrow] (a) to node[letter] {$x$} (b);
      \draw[xarrow] (b) to node[letter,swap] {$x$} (inner0);
      \draw[xarrow] (c) to node[letter] {$x$} (a);
      \draw[yarrow] (c) to node[letter,swap] {$y$} (inner288);
    \end{tikzpicture}
